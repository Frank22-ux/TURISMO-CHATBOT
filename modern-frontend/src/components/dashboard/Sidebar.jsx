...
import { Home, Calendar, History, MessageSquare, User, Mountain, LogOut, Compass, Star, Wallet } from 'lucide-react';
...
const Sidebar = ({ activeSection, setActiveSection }) => {
  ...
  const menuItems = [
    ...
    { id: 'payments', label: 'Mis Pagos', icon: Wallet },
  ...
  return (
    <aside className="w-full md:w-72 bg-white border-b md:border-b-0 md:border-r border-slate-100 flex flex-col h-auto md:h-screen sticky top-0 z-20 shadow-sm md:shadow-none">
      ...
      <div className="mt-auto p-8 space-y-2 border-t border-slate-50 hidden md:block">
